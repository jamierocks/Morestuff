...
public class WorldGenerationVolcanicRock implements IWorldGenerator {
	...
	private void generateSurface(World world, Random random, int blockX, int blockZ) {
		int Xcoord = blockX + random.nextInt(16);
		  ...
		  (new WorldGenMinable(mod_morestuff.Volcanicrock.blockID, 100)).generate(world, random, Xcoord, Ycoord, Zcoord);
